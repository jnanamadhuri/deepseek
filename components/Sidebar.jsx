    ...
    >
      <div className="">
          ...
          >
            ...
            <div
              className={`absolute w-max ${
                expand ? "left-0.5 -translate-x-0.5 top-12" : "-top-12 left-0"
            ...
            >
              ...
              <div
                ...
                ${
                  expand
                    ? "left-0.5 -top-1.5 -translate-x-0.5 "
                    : "left-4 -bottom-1.5"
                }`}
              ></div>
            </div>
        ...
        >
          ...
          group-hover:opacity-100 transition bg-black text-white text-sm
          px-3 py-2 rounded-lg shadow-lg pointer-events-none "
          >
            New Chat
            <div
              className="w-3 h-3  absolute bg-black rotate-45 left-4
                -bottom-1.5"
            ></div>
          </div>
      ...
      <div>
        <div
          className={`flex items-center cursor-pointer group relative ${
            expand
              ? "gap-1 text-white text-sm p-2.5 border border-primary rounded-lg hover:bg-white/10 cursor-pointer"
